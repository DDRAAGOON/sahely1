/// Full ITU/E.164 country list used by the phone country-code picker.
///
/// The flag emoji is derived from the ISO 3166-1 alpha-2 code using regional
/// indicator symbols, so no image assets are needed.
class Country {
  ...
  /// Flag emoji computed from the alpha-2 code (regional indicators).
  String get flag {
    const base = 0x1F1E6;
    final chars = code.toUpperCase().codeUnits;
    return String.fromCharCodes(
        [base + (chars.first - 65), base + (chars.last - 65)]);
  }

  String get displayCode => '$flag $dialCode';
}
...
class Countries {
  ...
  static const List<Country> all = [
    ...
    Country('TC', 'Turks & Caicos Islands', '+1649'),
    ...
    Country('VI', 'Virgin Islands (US)', '+1340'),
    Country('WF', 'Wallis & Futuna', '+681'),
    Country('YE', 'Yemen', '+967'),
    Country('ZM', 'Zambia', '+260'),
    Country('ZW', 'Zimbabwe', '+263'),
  ];

  static Country get egypt => all.firstWhere((c) => c.code == 'EG');

  /// Finds a country by its ISO code; falls back to Egypt.
