...
class AppColors {
  ...
  static const Color primaryLight = Color(0xFFD4B87A);
  static const Color primaryDark = Color(0xFFA08050);
  ...
  static const Color stepActive = navy;
  ...
  static const Color subtle = Color(0xFFD0D0D0);
  static const Color danger = Color(0xFFFF4848);
  static const Color owner = Color(0xFF1B2744);

  // ==================== icon ====================
  static const Color iconTileInactive = Color(0xFFEFE9DD);
