...
abstract class WishlistRepository {
  ...
  Future<List<WishlistItem>> getWishlistItemsByCollection(String collectionId, Role role);
  Future<List<WishlistItem>> getAllWishlistItems(Role role);
  Future<void> removeFromCollection(String propertyId, String collectionId, Role role);
