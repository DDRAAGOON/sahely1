            ...
            child: Column(
              children: [
                if (_selectedFilter == 'All' || _selectedFilter == 'Payouts')
                  _hist('Payout · Azure Villa', 'Jun 14 · to bank', '+18,000',
                      AppColors.success),
                if (_selectedFilter == 'All' || _selectedFilter == 'Payouts')
                  _hist('Payout · Golden Dunes', 'Jun 11 · Pending', '+15,200',
                      AppColors.navy,
                      pending: true),
                if (_selectedFilter == 'All' || _selectedFilter == 'Violations')
                  _hist('Cleaning damage fine', 'Jun 6 · Violation', '−500',
        ...
        children: [
          ...
          WhiteCard(
            ...
            child:
              ...
              Text(
                  'Broken glass table found after checkout and not declared in the post check-out report within 24h.',
                  style:
                      AppTheme.dm(size: 13, color: AppColors.ink, height: 1.5)),
              ...
              child: Row(children: [
                Expanded(
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                      Text('Late check-out cleaning',
                          style: AppTheme.dm(
                              size: 14,
                              weight: FontWeight.w700,
                              color: AppColors.navy)),
                      Text('Golden Dunes · May 20',
                          style: AppTheme.dm(size: 12, color: AppColors.muted)),
                    ])),
