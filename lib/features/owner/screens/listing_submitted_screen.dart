            ...
            children: [
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                              child: Column(
                                  ...
                                  children: [
                                Text('Reviewed within 1–24 hours',
                                    style: AppTheme.dm(
                                        size: 14,
                                        weight: FontWeight.w700,
                                        color: Colors.white)),
                                const SizedBox(height: 2),
                                Text("We'll notify you the moment it's decided",
                                    style: AppTheme.dm(
                                        size: 12,
                                        color: Colors.white
                      ...
                      Align(
                        ...
                        child: Text('What may happen next',
                            style: AppTheme.dm(
                                size: 14,
                                weight: FontWeight.w700,
                      ...
                      const _NextStepRow(
                          ...
                          text: 'Approved & published — goes live to guests'),
                      const _NextStepRow(
                          icon: Icons.monetization_on,
                          color: AppColors.gold,
                          text: 'Price recommendation to match the market'),
                      const _NextStepRow(
                          icon: Icons.photo_library,
                          color: Colors.orange,
                          text: 'Request for more / better photos'),
                      const _NextStepRow(
                          icon: Icons.cancel,
                          color: Color(0xFFB22222),
                          text:
                              'Asked to fix details, or declined with reasons',
                          last: true),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: GoldButton(
                    ...
                    onTap: () =>
                        AppNavigation.safeGo(context, '/owner/manage')),
              ),
            ],
          ),
        ),
