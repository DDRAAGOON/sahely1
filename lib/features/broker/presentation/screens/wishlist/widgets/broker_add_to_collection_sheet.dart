...
class BrokerAddToCollectionSheet extends StatefulWidget {
  ...
  @override
  State<BrokerAddToCollectionSheet> createState() => _BrokerAddToCollectionSheetState();
}

class _BrokerAddToCollectionSheetState extends State<BrokerAddToCollectionSheet> {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (state.status == BrokerWishlistStatus.loading && _collections.isEmpty)
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _selectedCollectionId != null ? () {
                    context.read<BrokerWishlistCubit>().addToCollection(propertyId: widget.propertyId, collectionId: _selectedCollectionId!);
