      ...
      child: ListView(
        ...
        children: [
          ...
          WhiteCard(
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Column(
                        ...
                        children: [
                      Text('Retroactive bonus',
                          style:
                              AppTheme.dm(size: 13, weight: FontWeight.w600)),
                      Text('Gold tier upgrade · Jun 13',
            ...
            _brk('Commission · Palm Chalet', 'Jun 12', '+1,820',
                AppColors.success),
            _brk('Commission · Dune House', 'Jun 9 · Pending', '+960',
                AppColors.navy,
          ...
          WhiteCard(
              child: Column(children: [
            _brk('Commission · Marina Loft', 'May 24', '+1,450',
                AppColors.success),
            _brk('Booking payment', 'Own stay · May 18', '−9,800',
