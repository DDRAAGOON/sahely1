        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              FieldGroup(
                label: 'Owner Name', 
                child: AppTextField(controller: _ownerController, hintText: 'Full name', height: 50)
              ),
              const SizedBox(height: 14),
              
              FieldGroup(
                label: 'Phone', 
                child: AppTextField(controller: _phoneController, hintText: '+20 ...', height: 50, keyboardType: TextInputType.phone)
              ),
              const SizedBox(height: 14),
              
              FieldGroup(
                label: 'Property Name', 
                child: AppTextField(controller: _propertyController, hintText: 'Property name', height: 50)
              ),
              const SizedBox(height: 14),
                ...
                child: Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      value: _selectedArea,
                      hint: Text('Select area', style: AppTheme.dm(size: 14, color: AppColors.faint)),
                      isExpanded: true,
                      icon: const Icon(Icons.keyboard_arrow_down, size: 18, color: AppColors.muted),
                      items: ['Marassi', 'Hacienda Bay', 'Telal', 'Amwaj', 'Seashell']
                          .map((e) => DropdownMenuItem(value: e, child: Text(e, style: AppTheme.dm(size: 14))))
                          .toList(),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text('Copy My Referral Link', style: AppTheme.dm(size: 15, weight: FontWeight.w700, color: AppColors.gold)),
                  ])),
                ),
              ),
            ],
