        ...
        children: [
          ...
          SizedBox(
              ...
              child:
                ...
                ChoiceChipPill('All 55', selected: true, height: 32),
                SizedBox(width: 8),
                ChoiceChipPill('Active 51', height: 32),
                SizedBox(width: 8),
          ...
          _refCard(
              ...
              124,
              4500,
              const ['Villa', '6 Guests', 'Pool', '🐾 Pets']),
          const SizedBox(height: 12),
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Wrap(spacing: 7, runSpacing: 7, children: [
                          for (final t in tags)
                            Pill(t,
                                border: AppColors.border, fg: AppColors.subtle)
                        ]),
                      ])),
            ]),
          ),
