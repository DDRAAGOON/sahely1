          ...
          children: [
            ...
            const SizedBox(height: 14),
             WhiteCard(child: Column(children: [
              ...
              SettingsRow(icon: Icons.account_balance_outlined, label: 'Payout Bank · IBAN', value: 'EG••4821', valueColor: AppColors.success, onTap: () => context.push('/broker/payout')),
              const SettingsRow(icon: Icons.notifications_none, label: 'Notifications'),
              SettingsRow(icon: Icons.lock_outline, label: 'Change Password', onTap: () => context.push('/change-password')),
              SettingsRow(icon: Icons.language, label: 'Language', value: 'English', onTap: () => context.push('/language')),
              SettingsRow(icon: Icons.attach_money, label: 'Currency', value: 'EGP', valueColor: AppColors.navy, onTap: () => context.push('/currency'), last: true),
            ])),
            const SizedBox(height: 14),
            WideButton(
              label: 'Log Out', 
