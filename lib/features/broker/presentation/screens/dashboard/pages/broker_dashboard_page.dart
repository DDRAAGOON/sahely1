        ...
        body: SafeArea(
          ...
          child: ListView(
            ...
            children: [
              ...
              // 4. White Stats Row
            Row(children: [
              _whiteStat(context, 'This Month', '18.2k', () => AppNavigation.goToBrokerWallet(context)),
              const SizedBox(width: 10),
              _whiteStat(context, 'Total Earned', '312k', () => AppNavigation.goToBrokerWallet(context)),
              const SizedBox(width: 10),
              _whiteStat(context, 'Live Props', '51', () => AppNavigation.goToBrokerPortfolio(context)),
            ]),
              const SizedBox(height: 12),
