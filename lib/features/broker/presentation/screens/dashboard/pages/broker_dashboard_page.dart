...
class BrokerDashboardPage extends StatelessWidget {
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _topPropertyItem(context, 'Palm Chalet', 'Owner: Layla M.', '86',
                '4,500', '+15.4k'),
            const SizedBox(height: 10),
            _topPropertyItem(context, 'Dune House', 'Owner: Tarek S.', '54',
                '3,800', '+8.2k'),
          ],
        ),
      ),
  ...
  Widget _topPropertyItem(BuildContext context, String name, String owner,
          String days, String avg, String profit) =>
      GestureDetector(
