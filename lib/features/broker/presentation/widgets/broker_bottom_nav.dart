...
class BrokerBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      _NavItem(activeIcon: Icons.notifications, inactiveIcon: Icons.notifications_none_outlined, label: 'Services'),
      _NavItem(activeIcon: Icons.home_work, inactiveIcon: Icons.home_work_outlined, label: 'My Role'),
    ];
