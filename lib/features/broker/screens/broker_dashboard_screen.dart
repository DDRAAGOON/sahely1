...
class _DashboardContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Row(children: [
          Expanded(child: _actionTile(context, 'Wallet', Icons.account_balance_wallet_outlined, '/broker/wallet')),
          const SizedBox(width: 10),
          Expanded(child: _actionTile(context, 'Portfolio', Icons.pie_chart_outline, '/broker/portfolio')),
          const SizedBox(width: 10),
          Expanded(child: _actionTile(context, 'Refer', Icons.group_add_outlined, '/broker/refer')),
        ]),
        const SizedBox(height: 12),
  ...
  Widget _actionTile(BuildContext context, String label, IconData icon, String route) => GestureDetector(
