...
class PropertyReviewsScreen extends StatelessWidget {
        ...
        children: [
            ...
            child: TopBar(
              ...
              trailing: Row(
                children: [
                  ...
                  Text('$pRating', style: AppTheme.dm(size: 14, weight: FontWeight.w700, color: AppColors.navy)),
                ],
              ),
            ),
          ),
          Expanded(
            child: ListView(
              ...
              children: [
                _fullReview('Nour A.', 'Renter', BadgeKind.renterLight, 5, 'Jun 2026',
                ...
                _fullReview('Omar K.', 'Renter', BadgeKind.renterLight, 5, 'May 2026',
  ...
  static Widget _fullReview(String name, String role, BadgeKind kind, int stars, String date, String body) {
    return WhiteCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        for (var i = 0; i < 5; i++)
                          Icon(Icons.star, size: 12, color: i < stars ? AppColors.gold : AppColors.border),
