  ...
  void _pickImage() async {
    ...
    if (image != null) {
      ...
      setState(() {
        ...
        _messages.add({
          'role': 'agent',
          'text': "I've received the photo. Our team is reviewing the issue now. ETA for a technician is still under 60 min."
        });
      });
    }
  }
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                ...
                Text(widget.owner ? 'SOS · Live Support' : 'Sahely Support · SOS',
                ...
                Row(children: [
                  ...
                  Text(widget.owner ? 'Agent connected · priority' : 'Agent connected · live now',
                      style: AppTheme.dm(size: 11, color: Colors.white70)),
                ]),
              ])),
          ...
          Flexible(
              child: Container(
                  ...
                  child: msg['imagePath'] != null
                      ...
                      : Text(msg['text'] ?? '', style: AppTheme.dm(size: 13, color: Colors.white, height: 1.4)))),
        ]),
      );
