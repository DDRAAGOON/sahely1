        ...
        children: [
          Expanded(
            child: ListView(
              ...
              children: [
                TopBar(
                    title: role == PastBookingRole.owner
                        ? 'Booking History'
                        : 'Past Referral'),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(AppLocalizations.of(context).includedInStay,
                  ...
                  const SizedBox(height: 32),
                  NavyButton(
                      label: AppLocalizations.of(context).rebookProperty,
                      onTap: () {}),
