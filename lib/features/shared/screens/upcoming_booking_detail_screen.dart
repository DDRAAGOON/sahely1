...
class UpcomingBookingDetailScreen extends StatelessWidget {
  ...
  const UpcomingBookingDetailScreen({super.key, this.property});
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    SahelyImage(
                        imageUrl: img, enableViewer: true, fadeHeight: 120),
                    const DecoratedBox(
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Text('Hacienda Bay, Marassi · North Coast',
                                  style: AppTheme.dm(
                                      size: 12,
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        const Icon(Icons.schedule,
                            size: 20, color: Color(0xFF8A6A1E)),
  ...
  Widget _featurePill(String label) => Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: const Color(0xFF22335A).withValues(alpha: 0.8),
                width: 1.1),
