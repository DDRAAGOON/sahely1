        ...
        child: EntranceFaded(
          child: BlocBuilder<WishlistCubit, WishlistState>(
            builder: (context, state) {
              ...
              // Distinct listings, not the sum of the collections: one
              // property saved in three collections is still one property.
              final totalPlaces = state.items.length;
                            ...
                            return GestureDetector(
                              ...
                              child: WishlistCollectionCard(
                                ...
                                isShared: collection.isShared ||
                                    collection.members.isNotEmpty,
                                sharedWith: collection.members.isNotEmpty
                                    ? collection.members.length
                                    : null,
                              ),
                            );
