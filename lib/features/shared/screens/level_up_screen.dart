          ...
          children: [
            ...
            Text('LEVEL 3 UNLOCKED',
                style: AppTheme.dm(
                    ...
                    color: const Color(0xFF3A9B8E),
                    letterSpacing: 3)),
            const SizedBox(height: 8),
            Text("You're a Wave Rider!",
                style: AppTheme.dm(
                    size: 27, weight: FontWeight.w700, color: AppColors.navy)),
            const SizedBox(height: 10),
            Text(
                '15% off all concierge services is now active for the rest of this season.',
                textAlign: TextAlign.center,
                style:
                    AppTheme.dm(size: 14, color: AppColors.muted, height: 1.5)),
            const SizedBox(height: 18),
            WhiteCard(
