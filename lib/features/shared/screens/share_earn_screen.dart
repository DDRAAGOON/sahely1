    ...
    return _SheetScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("You're checked in 🎉", style: AppTheme.dm(size: 20, weight: FontWeight.w700, color: AppColors.navy)),
          ...
          Padding(
            ...
            child: RichText(
                ...
                text: TextSpan(style: AppTheme.dm(size: 14, color: AppColors.muted, height: 1.5), children: const [
                  ...
                  TextSpan(text: '@sahelyeg', style: TextStyle(fontWeight: FontWeight.w700, color: Color(0xFFB0468A))),
          ...
          Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('Earn +5 Sahel Stars',
                    style: AppTheme.dm(size: 14, weight: FontWeight.w700, color: const Color(0xFF9A7A22)))
              ])),
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('Share to Instagram', style: AppTheme.dm(size: 15, weight: FontWeight.w700, color: Colors.white))
                ])),
          ),
          const SizedBox(height: 14),
          GestureDetector(
              onTap: () => Navigator.maybePop(context),
              child: Text('Maybe later', style: AppTheme.dm(size: 13, color: AppColors.muted))),
        ],
      ),
    );
  }
...
class _SheetScaffold extends StatelessWidget {
  const _SheetScaffold({required this.child, required this.bg, this.sheetColor});
  final Widget child;
  final Gradient bg;
