...
class _CreateAccountPageState extends State<CreateAccountPage> {
  ...
  void _onCreateAccountPressed(UserRole role) {
  ...
  Widget build(BuildContext context) {
    ...
    final UserRole role = _parseRole(roleArg);
              ...
              children: [
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: Text('Registering as: ${role.name.toUpperCase()}',
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          const TextSpan(text: 'Terms', style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.navy)),
                          const TextSpan(text: ' & ', style: TextStyle(color: AppColors.muted)),
                          const TextSpan(text: 'Privacy Policy', style: TextStyle(fontWeight: FontWeight.w700, color: AppColors.navy)),
                        ],
                      ),
                    ),
                  ],
                ...
                BlocBuilder<AuthBloc, AuthState>(
                  builder: (context, state) {
                    return NavyButton(
                      label: state is AuthLoading ? 'Creating Account...' : 'Create Account',
                      onTap: state is AuthLoading ? null : () => _onCreateAccountPressed(role),
                    );
                  },
                ),
              ],
